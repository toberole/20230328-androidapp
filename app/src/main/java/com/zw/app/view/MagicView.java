...
public class MagicView extends View {
    ...
    public MagicView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.MagicView);
//        mRadius = ta.getDimension(R.styleable.MagicView_radius, mRadius);
//        int resourceId = ta.getResourceId(R.styleable.MagicView_colors, -1);
        String[] colors = null;
//        if (resourceId != -1) {
...
//        }
    ...
    public void refreshFlushUI(List<Point> points) {
